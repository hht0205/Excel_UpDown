...
public class DBUtilMysql {
      ...
      public static  List<Map<String, Object>> query(String sql) {
          ...
          List<Map<String, Object>> map=(List<Map<String, Object>>)new QueryRunner().query(conn, sql, new MapListHandler());
          return map;
      ...
      static String url = Configuration.getGlobalMsg("jdbc.url");
